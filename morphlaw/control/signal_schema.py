"""Signal contracts and dimensional inference for symbolic feedback laws.
...
from morphlaw.control.expression import BinaryOp, Const, ProductOp, Scale, Signal, SumOp, UnaryOp
...
def contract_for(env_id, allowed):
    ...
    if env_id == "Reacher-v5":
        ...
        "PandaReachDense-v3", "MorphlawPandaReachMoving-v0",
        "PandaPushDense-v3",
        "PandaSlideDense-v3",
    ):
