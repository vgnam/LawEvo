...
from morphlaw.control.panda_gym_benchmark import (
    PICK_DISTANCE_SCALE,
    PUSH_DISTANCE_SCALE,
...
REACH_MOVING_ENV_ID = "MorphlawPandaReachMoving-v0"
PUSH_ICE_ENV_ID = "MorphlawPandaPushIce-v0"
SLIDE_GATE_ENV_ID = "MorphlawPandaSlideGate-v0"
PICK_DISTRACTOR_ENV_ID = "MorphlawPandaPickDistractor-v0"
STACK_NARROW_ENV_ID = "MorphlawPandaStackNarrow-v0"

# Fixed SR/SG/Q thresholds, shared by every controller class (humans, classical
# optimization, random symbolic laws, and MorphLaw). Reach/tracking tolerance and
...
REACH_MORPH_ENV_ID = "MorphlawPandaReach-v1"
PUSH_MORPH_ENV_ID = "MorphlawPandaPush-v1"
SLIDE_MORPH_ENV_ID = "MorphlawPandaSlide-v1"
PICK_MORPH_ENV_ID = "MorphlawPandaPickAndPlace-v1"
STACK_MORPH_ENV_ID = "MorphlawPandaStack-v1"
...
def _install_quiet_bullet_client() -> None:
    ...
    if getattr(PyBullet, "_morphlaw_quiet", False):
        return
...
def _morphable_panda_factory():
    ...
    class MorphablePanda(Panda):
        def __init__(self, sim, urdf_path, block_gripper=False, base_position=None, control_type="ee"):
            self._morphlaw_urdf_path = str(urdf_path)
            super().__init__(
                sim,
        ...
        def _load_robot(self, file_name, base_position):
            ...
            os.chdir(os.path.dirname(os.path.abspath(self._morphlaw_urdf_path)))
            try:
                self.sim.loadURDF(
                    body_name=self.body_name,
                    fileName=self._morphlaw_urdf_path,
