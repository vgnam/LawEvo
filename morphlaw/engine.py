...
from morphlaw.evaluate import PairMetrics, tune_pair_cem
from morphlaw.knowledge import (
    KNOWLEDGE_MODES,
    DirectedKnowledgeBase,
    EvidenceRecord,
    KnowledgeHypothesis,
)
from morphlaw.morphology import (
    MorphologyError,
    MorphologyGenome,
    MorphologyTemplate,
)
from morphlaw.navigator import MorphLawNavigator, SearchDirective
from morphlaw.proposals import LawProposal, MorphologyProposal
from morphlaw.control.gym_benchmark import BenchmarkAdapter, GymStructure


@dataclass(frozen=True)
class MorphLawConfig:
    generations: int = 5
...
@dataclass(frozen=True)
class MorphLawGenerationReport:
    generation: int
    incumbent: str
    best_score: float
    evaluated: int
...
class MorphLawRunner:
    ...
    def __init__(
        ...
        config: MorphLawConfig | None = None,
        ...
        self.config = config or MorphLawConfig()
        ...
        self.navigator = MorphLawNavigator()
        self.reports: list[MorphLawGenerationReport] = []
    ...
    def run(
    ...
    ) -> tuple[PairRecord, list[MorphLawGenerationReport]]:
        ...
        for generation in range(1, self.config.generations + 1):
            ...
            report = MorphLawGenerationReport(
                generation,
